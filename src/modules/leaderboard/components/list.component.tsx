...
export const List: React.FC<LeaderboardListProps> = ({ list, lastUserElementRef }: LeaderboardListProps) => {
  ...
  return (
    <section className='relative w-full h-full mt-[30px] pb-20'>
      {statistics && (
        <div className='default-btn absolute bottom-20 w-full z-10 flex items-center justify-between px-4 h-[76px]'>
